...
public class ModTileEntities {
    ...
    public static final RegistryObject<TileEntityType<ShopTile>> SHOP_TILE_ENTITY =
            Registration.TILE_ENTITY_TYPES.register("shop_tile_entity", () -> TileEntityType.Builder.create(
                    () -> new ShopTile(), ModBlocks.SHOP.get()).build(null)
    );
