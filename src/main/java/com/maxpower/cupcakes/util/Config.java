...
public class Config {
    ...
    static {
        ...
        glowingConfiguration(SERVER_BUILDER, CLIENT_BUILDER);

        SERVER_CONFIG = SERVER_BUILDER.build();
        CLIENT_CONFIG = CLIENT_BUILDER.build();
    }
    // TODO: Watch how to remove or use this
    private static void  glowingConfiguration(ForgeConfigSpec.Builder SERVER_BUILDER,
